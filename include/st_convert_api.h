 ...
 *
 * This header define the public interfaces of streaming(st2110) format
 * conversion toolkit
 *
 */
 ...
 */
static inline int
st20_rfc4175_422be10_to_yuv422p10le(struct st20_rfc4175_422_10_pg2_be *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_yuv422p10le_simd(pg, y, b, r, w, h,
                                                  MTL_SIMD_LEVEL_MAX);
}

/** helper to call st20_rfc4175_422be10_to_yuv422p10le with mtl_cpuva_t type for
 * python binding
 */
static inline int
st20_rfc4175_422be10_to_yuv422p10le_cpuva(mtl_cpuva_t pg_be, mtl_cpuva_t y,
                                          mtl_cpuva_t b, mtl_cpuva_t r,
                                          uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_yuv422p10le(
      (struct st20_rfc4175_422_10_pg2_be *)pg_be, (uint16_t *)y, (uint16_t *)b,
      (uint16_t *)r, w, h);
}
 ...
 */
static inline int
st20_rfc4175_422be10_to_422le10(struct st20_rfc4175_422_10_pg2_be *pg_be,
                                struct st20_rfc4175_422_10_pg2_le *pg_le,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_422le10_simd(pg_be, pg_le, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be10_to_v210(struct st20_rfc4175_422_10_pg2_be *pg_be,
                             uint8_t *pg_v210, uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_v210_simd(pg_be, pg_v210, w, h,
                                           MTL_SIMD_LEVEL_MAX);
}

/** helper to call st20_rfc4175_422be10_to_v210 with mtl_cpuva_t type for python
 * binding
 */
static inline int st20_rfc4175_422be10_to_v210_cpuva(mtl_cpuva_t pg_be,
                                                     mtl_cpuva_t pg_v210,
                                                     uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_v210(
      (struct st20_rfc4175_422_10_pg2_be *)pg_be, (uint8_t *)pg_v210, w, h);
}

/**
 * Convert rfc4175_422be10 to rfc4175_422le8(packed UYVY) with the max optimized
 * SIMD level.
 *
 * @param pg_10
 *   Point to pg(rfc4175_422be10) data.
 ...
 */
static inline int
st20_rfc4175_422be10_to_422le8(struct st20_rfc4175_422_10_pg2_be *pg_10,
                               struct st20_rfc4175_422_8_pg2_le *pg_8,
                               uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_422le8_simd(pg_10, pg_8, w, h,
                                             MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be10_to_yuv422p8(struct st20_rfc4175_422_10_pg2_be *pg,
                                 uint8_t *y, uint8_t *b, uint8_t *r, uint32_t w,
                                 uint32_t h) {
  return st20_rfc4175_422be10_to_yuv422p8_simd(pg, y, b, r, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be10_to_yuv420p8(struct st20_rfc4175_422_10_pg2_be *pg,
                                 uint8_t *y, uint8_t *b, uint8_t *r, uint32_t w,
                                 uint32_t h) {
  return st20_rfc4175_422be10_to_yuv420p8_simd(pg, y, b, r, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be12_to_yuv422p12le(struct st20_rfc4175_422_12_pg2_be *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
  return st20_rfc4175_422be12_to_yuv422p12le_simd(pg, y, b, r, w, h,
                                                  MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be12_to_422le12(struct st20_rfc4175_422_12_pg2_be *pg_be,
                                struct st20_rfc4175_422_12_pg2_le *pg_le,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_422be12_to_422le12_simd(pg_be, pg_le, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be10_to_yuv444p10le(struct st20_rfc4175_444_10_pg4_be *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
  return st20_rfc4175_444be10_to_444p10le_simd(pg, y, b, r, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be10_to_gbrp10le(struct st20_rfc4175_444_10_pg4_be *pg,
                                 uint16_t *g, uint16_t *b, uint16_t *r,
                                 uint32_t w, uint32_t h) {
  return st20_rfc4175_444be10_to_444p10le_simd(pg, g, r, b, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be10_to_444le10(struct st20_rfc4175_444_10_pg4_be *pg_be,
                                struct st20_rfc4175_444_10_pg4_le *pg_le,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_444be10_to_444le10_simd(pg_be, pg_le, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be12_to_yuv444p12le(struct st20_rfc4175_444_12_pg2_be *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
  return st20_rfc4175_444be12_to_444p12le_simd(pg, y, b, r, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be12_to_gbrp12le(struct st20_rfc4175_444_12_pg2_be *pg,
                                 uint16_t *g, uint16_t *b, uint16_t *r,
                                 uint32_t w, uint32_t h) {
  return st20_rfc4175_444be12_to_444p12le_simd(pg, g, r, b, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444be12_to_444le12(struct st20_rfc4175_444_12_pg2_be *pg_be,
                                struct st20_rfc4175_444_12_pg2_le *pg_le,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_444be12_to_444le12_simd(pg_be, pg_le, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_yuv422p10le_to_rfc4175_422be10(uint16_t *y, uint16_t *b, uint16_t *r,
                                    struct st20_rfc4175_422_10_pg2_be *pg,
                                    uint32_t w, uint32_t h) {
  return st20_yuv422p10le_to_rfc4175_422be10_simd(y, b, r, pg, w, h,
                                                  MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_v210_to_rfc4175_422be10(uint8_t *pg_v210,
                             struct st20_rfc4175_422_10_pg2_be *pg_be,
                             uint32_t w, uint32_t h) {
  return st20_v210_to_rfc4175_422be10_simd(pg_v210, pg_be, w, h,
                                           MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422le10_to_422be10(struct st20_rfc4175_422_10_pg2_le *pg_le,
                                struct st20_rfc4175_422_10_pg2_be *pg_be,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_422le10_to_422be10_simd(pg_le, pg_be, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
...
static inline int st20_rfc4175_422le10_to_v210(uint8_t *pg_le, uint8_t *pg_v210,
                                               uint32_t w, uint32_t h) {
  return st20_rfc4175_422le10_to_v210_simd(pg_le, pg_v210, w, h,
                                           MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422be10_to_y210(struct st20_rfc4175_422_10_pg2_be *pg_be,
                             uint16_t *pg_y210, uint32_t w, uint32_t h) {
  return st20_rfc4175_422be10_to_y210_simd(pg_be, pg_y210, w, h,
                                           MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_y210_to_rfc4175_422be10(uint16_t *pg_y210,
                             struct st20_rfc4175_422_10_pg2_be *pg_be,
                             uint32_t w, uint32_t h) {
  return st20_y210_to_rfc4175_422be10_simd(pg_y210, pg_be, w, h,
                                           MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_yuv422p12le_to_rfc4175_422be12(uint16_t *y, uint16_t *b, uint16_t *r,
                                    struct st20_rfc4175_422_12_pg2_be *pg,
                                    uint32_t w, uint32_t h) {
  return st20_yuv422p12le_to_rfc4175_422be12_simd(y, b, r, pg, w, h,
                                                  MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_422le12_to_422be12(struct st20_rfc4175_422_12_pg2_le *pg_le,
                                struct st20_rfc4175_422_12_pg2_be *pg_be,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_422le12_to_422be12_simd(pg_le, pg_be, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_yuv444p10le_to_rfc4175_444be10(uint16_t *y, uint16_t *b, uint16_t *r,
                                    struct st20_rfc4175_444_10_pg4_be *pg,
                                    uint32_t w, uint32_t h) {
  return st20_444p10le_to_rfc4175_444be10_simd(y, b, r, pg, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444le10_to_444be10(struct st20_rfc4175_444_10_pg4_le *pg_le,
                                struct st20_rfc4175_444_10_pg4_be *pg_be,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_444le10_to_444be10_simd(pg_le, pg_be, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_yuv444p10le_to_rfc4175_444le10(uint16_t *y, uint16_t *b, uint16_t *r,
 ...
 */
static inline int
st20_rfc4175_444le10_to_yuv444p10le(struct st20_rfc4175_444_10_pg4_le *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
 ...
 */
static inline int
st20_gbrp10le_to_rfc4175_444be10(uint16_t *g, uint16_t *b, uint16_t *r,
                                 struct st20_rfc4175_444_10_pg4_be *pg,
                                 uint32_t w, uint32_t h) {
  return st20_444p10le_to_rfc4175_444be10_simd(g, r, b, pg, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_gbrp10le_to_rfc4175_444le10(uint16_t *g, uint16_t *b, uint16_t *r,
                                 struct st20_rfc4175_444_10_pg4_le *pg,
                                 uint32_t w, uint32_t h) {
 ...
 */
static inline int
st20_rfc4175_444le10_to_gbrp10le(struct st20_rfc4175_444_10_pg4_le *pg,
                                 uint16_t *g, uint16_t *b, uint16_t *r,
                                 uint32_t w, uint32_t h) {
 ...
 */
static inline int
st20_yuv444p12le_to_rfc4175_444be12(uint16_t *y, uint16_t *b, uint16_t *r,
                                    struct st20_rfc4175_444_12_pg2_be *pg,
                                    uint32_t w, uint32_t h) {
  return st20_444p12le_to_rfc4175_444be12_simd(y, b, r, pg, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_rfc4175_444le12_to_444be12(struct st20_rfc4175_444_12_pg2_le *pg_le,
                                struct st20_rfc4175_444_12_pg2_be *pg_be,
                                uint32_t w, uint32_t h) {
  return st20_rfc4175_444le12_to_444be12_simd(pg_le, pg_be, w, h,
                                              MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_yuv444p12le_to_rfc4175_444le12(uint16_t *y, uint16_t *b, uint16_t *r,
 ...
 */
static inline int
st20_rfc4175_444le12_to_yuv444p12le(struct st20_rfc4175_444_12_pg2_le *pg,
                                    uint16_t *y, uint16_t *b, uint16_t *r,
                                    uint32_t w, uint32_t h) {
 ...
 */
static inline int
st20_gbrp12le_to_rfc4175_444be12(uint16_t *g, uint16_t *b, uint16_t *r,
                                 struct st20_rfc4175_444_12_pg2_be *pg,
                                 uint32_t w, uint32_t h) {
  return st20_444p12le_to_rfc4175_444be12_simd(g, r, b, pg, w, h,
                                               MTL_SIMD_LEVEL_MAX);
}
 ...
 */
static inline int
st20_gbrp12le_to_rfc4175_444le12(uint16_t *g, uint16_t *b, uint16_t *r,
                                 struct st20_rfc4175_444_12_pg2_le *pg,
                                 uint32_t w, uint32_t h) {
 ...
 */
static inline int
st20_rfc4175_444le12_to_gbrp12le(struct st20_rfc4175_444_12_pg2_le *pg,
                                 uint16_t *g, uint16_t *b, uint16_t *r,
                                 uint32_t w, uint32_t h) {
