...
impl Fps {
    ...
    pub fn to_float(self) -> Result<f32> {
        match self {
            Fps::P59_94 => Ok(60000.0 / 1001.0),
            Fps::P50 => Ok(50000.0 / 1000.0),
            Fps::P29_97 => Ok(30000.0 / 1001.0),
            Fps::P25 => Ok(25000.0 / 1000.0),
            Fps::P119_88 => Ok(11988.0 / 1000.0),
            Fps::P120 => Ok(12000.0 / 1000.0),
            Fps::P100 => Ok(10000.0 / 1000.0),
            Fps::P60 => Ok(60000.0 / 1000.0),
            Fps::P30 => Ok(30000.0 / 1000.0),
            Fps::P24 => Ok(24000.0 / 1000.0),
            Fps::P23_98 => Ok(24000.0 / 1001.0),
        }
    }
}
