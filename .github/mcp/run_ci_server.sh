...
#
# Bootstrap wrapper for the MTL local-CI MCP server.
# Auto-creates the Python venv and installs dependencies if missing.
# Called by .vscode/mcp.json — do not invoke mtl_ci_mcp_server.py directly.
...
SERVER="$SCRIPT_DIR/mtl_ci_mcp_server.py"
