...
**The tradeoff**: Pipeline adds one level of frame copying (if conversion needed) and one mutex per operation. For most use cases this overhead is negligible. For 4K120 or multi-stream, every copy matters.
