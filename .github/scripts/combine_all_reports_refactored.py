...
from report_generators.parsers import parse_pytest_html, parse_gtest_log, parse_system_info
...
def main():
    ...
    parser.add_argument('--pytest-dir', required=True, help='Directory containing pytest HTML reports')
    parser.add_argument('--gtest-dir', required=True, help='Directory containing gtest log files')
    ...
    parser.add_argument('--system-info-dir', help='Directory containing system info files')
    ...
    generate_excel_report(pytest_data, gtest_data, args.output_excel, system_info_list, test_metadata)
    
    print("Generating HTML report...")
    generate_html_report(pytest_data, gtest_data, args.output_html, system_info_list, test_metadata)
