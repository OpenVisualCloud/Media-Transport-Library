...
void poc_stats_report(poc_stats_t *stats, const char *role)
{
    ...
    printf("{\"role\":\"%s\","
           ...
           (unsigned long)(lq.count ? lq.min_us : 0),
           (unsigned long)lq.max_us,
           (unsigned long)poc_latency_avg(&lq),
           (unsigned long)lq.count,
           (unsigned long)(lb.count ? lb.min_us : 0),
           (unsigned long)lb.max_us,
           (unsigned long)poc_latency_avg(&lb),
           (unsigned long)lb.count,
           (unsigned long)(lr.count ? lr.min_us : 0),
           (unsigned long)lr.max_us,
           (unsigned long)poc_latency_avg(&lr),
           (unsigned long)lr.count,
           (unsigned long)(lt.count ? lt.min_us : 0),
           (unsigned long)lt.max_us,
           (unsigned long)poc_latency_avg(&lt),
           (unsigned long)lt.count,
           (unsigned long)(lc.count ? lc.min_us : 0),
           (unsigned long)lc.max_us,
           (unsigned long)poc_latency_avg(&lc),
           (unsigned long)lc.count,
           (unsigned long)(le.count ? le.min_us : 0),
           (unsigned long)le.max_us,
           (unsigned long)poc_latency_avg(&le),
