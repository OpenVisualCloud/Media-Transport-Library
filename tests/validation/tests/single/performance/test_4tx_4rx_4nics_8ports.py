...
def test_perf_4tx_4rx_4nics_8ports(
    hosts, build, media, nic_port_list, test_time, video_format, test_config, prepare_ramdisk
):
    ...
    rxtxapp.log_to_file(f"Starting 4TX+4RX performance test for {video_format}", host, build)
    ...
    while True:
        ...
        capture_cfg["test_name"] = f"test_perf_4tx_4rx_4nics_8ports_upper_{video_format}_{replicas_b}"
    ...
    while True:
        ...
        capture_cfg = dict(test_config.get("capture_cfg", {}))
        capture_cfg["test_name"] = f"test_perf_4tx_4rx_4nics_8ports_search_{video_format}_{replicas_midpoint}"
