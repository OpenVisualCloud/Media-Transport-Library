...
def test_resolutions(
    ...
    """
    Validate multicast ST20P streaming across the full catalog of YUV422 RFC4175
    sample resolutions to ensure pipeline configuration scales with frame size and
    bitrate. Packet capture is enabled to aid troubleshooting if large-frame
    configurations expose fragmentation or pacing issues.
