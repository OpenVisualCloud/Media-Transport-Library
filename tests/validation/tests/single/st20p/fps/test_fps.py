...
def test_fps(
    ...
    """
    Validate unicast ST20P streaming across a matrix of frame rates to ensure
    timing support and pacing align with the configured FPS values for 1080p
    YUV422 RFC4175. This catches regressions in rate configuration or jitter
    handling across low (23/24/25) and high (100/119/120) frame rates.
    ...
    :param fps: Frame rate string (e.g., ``p23``) selected from the parametrized list.
