...
def test_st30p_format(hosts, build, media, nic_port_list, test_time, audio_format, test_config, prepare_ramdisk):
    ...
    capture_cfg["test_name"] = f"test_st30p_format_{audio_format}" # Set a unique pcap file name
