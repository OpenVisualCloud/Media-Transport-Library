...
def test_multicast(hosts, build, media, nic_port_list, test_time, audio_format, test_config, prepare_ramdisk):
    ...
    capture_cfg["test_name"] = f"test_multicast_{audio_format}" # Set a unique pcap file name
