...
def test_ptp_video_format(
    hosts, build, media, nic_port_list, test_time, test_mode, video_format, replicas, test_config, prepare_ramdisk
):
    ...
    capture_cfg["test_name"] = f"test_ptp_video_format_{test_mode}_{video_format}_replicas{replicas}"
