...
def test_packing(hosts, build, media, nic_port_list, test_time, file, packing, test_config, prepare_ramdisk):
    ...
    capture_cfg["test_name"] = f"test_packing_{file}_{packing}" # Set a unique pcap file name
