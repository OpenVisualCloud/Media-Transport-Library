...
def test_pacing(hosts, build, media, nic_port_list, test_time, file, pacing, test_config, prepare_ramdisk):
    ...
    capture_cfg["test_name"] = f"test_pacing_{file}_{pacing}" # Set a unique pcap file name
