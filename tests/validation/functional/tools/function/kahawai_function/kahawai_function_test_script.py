...
yuv_dict = dict(
    i1080p59="Netflix_Crosswalk_1920x1080_10bit_60Hz_P422_yuv422p10be_To_yuv422YCBCR10be.yuv",
...
sample_json_file_dict = dict(
    i1080p59="1080p59_1v.json",
...
def copy_json_file():
    if json_file_mode == "1_json_file":
        scr_json = (
            ...
            + "loop_json"
            + slash
            + sample_json_file_dict[video_format]
        )
        ...
        for test_mode in test_mode_list:
            for type_mode in type_mode_list:
                ...
                if json_file_mode == "1_json_file":
                    ...
                    json_file_list = [
                        tx_json_file_name_global,
                        rx_json_file_name_global,
                    ]
                copy_json_file()
                modify_json_file()
