...
def modify_json_file(
    json_path, json_file_list, json_file_mode, modify_mode, parameter_name, value_list
):
    ...
    if json_file_mode == "1_json_file":
        ...
        actually_modify_json_file(
            json_path, json_file_name, modify_mode, parameter, value_dict
        )
    else:
...
if __name__ == "__main__":
    ...
    init_json_file(
        json_path_g, json_file_list_g, json_file_mode_g, port_dict_g, ip_dict_g
    )
    modify_json_file(
        json_path_g,
        json_file_list_g,
