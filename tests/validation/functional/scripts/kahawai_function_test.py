...
yaml_file = 'configs' + slash + 'kahawai_function_test.yaml'
config_file_path = os.path.join(os.getcwd(), yaml_file)
running_test_path = 'tools' + slash + 'function' + slash + 'kahawai_function'
log_file = 'logs' + slash + 'kahawai_function_test' + slash + 'kahawai_function_test.log'
