...
yaml_file = 'configs' + slash + 'kahawai_API_test.yaml'
config_file_path = os.path.join(os.getcwd(), yaml_file)
running_test_path = 'tools' + slash + 'api' + slash + 'kahawai_api'
log_file = 'logs' + slash + 'kahawai_API_test' + slash + 'kahawai_API_test.log'
