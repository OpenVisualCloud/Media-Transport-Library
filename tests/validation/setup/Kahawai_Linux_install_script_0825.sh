...
if [ ! -e libraries.media.st2110.kahawai.tgz ]
then
...
function check_ice_version(){
    ...
    if [[ -z ${actual_ice_version} ]] || [[ -z ${actual_ddp_version} ]]
    then
