...
def modify_json_file(json_file_list, json_file_mode, modify_mode, parameter_name, value_list):
    line_index = 0
...
if __name__ == '__main__':
    ...
    modify_json_file(json_file_list_g, json_file_mode_g, "parameter", "replicas", value_list_g)
