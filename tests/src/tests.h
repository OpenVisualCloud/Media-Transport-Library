...
struct st_tests_context {
  ...
  struct test_converter_session
      *converter_sessions[MAX_TEST_CONVERTER_SESSIONS];
...
static inline void st_test_jxs_fail_interval(struct st_tests_context *ctx,
                                             int interval) {
...
static inline void st_test_jxs_timeout_ms(struct st_tests_context *ctx,
                                          int ms) {
  ctx->plugin_timeout_ms = ms;
}

static inline void st_test_jxs_rand_ratio(struct st_tests_context *ctx,
                                          int rand_ratio) {
  ctx->plugin_rand_ratio = rand_ratio;
}

static inline void st_test_jxs_use_block_get(struct st_tests_context *ctx,
                                             bool block) {
