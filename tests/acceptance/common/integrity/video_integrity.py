...
def calculate_yuv_frame_size(width: int, height: int, file_format: str) -> int:
    match file_format:
        ...
        case "YUV422PLANAR10LE" | "yuv422p10le":
            pixel_size = 4
        case "YUV422PLANAR12LE" | "yuv422p12le":
            # 4:2:2 12-bit planar: Y full + half U + half V, 2 bytes per sample
            pixel_size = 4
        case "YUV444PLANAR10LE" | "GBRPLANAR10LE" | "yuv444p10le" | "gbrp10le":
        ...
        case "Y210" | "y210le":
            ...
            pixel_size = 4
        case "v210":
            # Packed 4:2:2 10-bit: each row is padded to 48-pixel blocks of 128 bytes
