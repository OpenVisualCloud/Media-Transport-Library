...
#
# Disabled: this single-host performance suite is not valid any more and is
# pending removal. No CI job selects it -- the performance job runs
# tests/dual/performance, and the nightly selects by marker, which these
# modules never carried. Left commented out so that removal is a separate,
# reviewable change.
...
#     ],
# )
# def test_perf_2tx_2nics_2ports(
#     hosts,
#     mtl_path,
#     media,
