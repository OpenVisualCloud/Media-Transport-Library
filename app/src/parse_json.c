...
static inline json_object *st_json_object_object_get(json_object *obj,
                                                     const char *key) {
...
static int st_json_parse_interfaces(json_object *interface_obj,
  ...
  const char *ip =
      json_object_get_string(st_json_object_object_get(interface_obj, "ip"));
  if (ip)
...
static int parse_base_udp_port(json_object *obj, st_json_session_base_t *base,
                               int idx) {
  int start_port =
      json_object_get_int(st_json_object_object_get(obj, "start_port"));
...
static int parse_base_payload_type(json_object *obj,
                                   st_json_session_base_t *base) {
  json_object *payload_type_object =
      st_json_object_object_get(obj, "payload_type");
...
static int parse_video_type(json_object *video_obj,
                            st_json_video_session_t *video) {
  const char *type =
      json_object_get_string(st_json_object_object_get(video_obj, "type"));
  REQUIRED_ITEM(type);
...
static int parse_video_pacing(json_object *video_obj,
                              st_json_video_session_t *video) {
  const char *pacing =
...
static int parse_video_packing(json_object *video_obj,
                               st_json_video_session_t *video) {
  const char *packing =
...
static int parse_video_tr_offset(json_object *video_obj,
                                 st_json_video_session_t *video) {
...
static int parse_video_format(json_object *video_obj,
                              st_json_video_session_t *video) {
  const char *video_format = json_object_get_string(
...
static int parse_video_pg_format(json_object *video_obj,
                                 st_json_video_session_t *video) {
...
static int parse_url(json_object *obj, const char *name, char *url) {
  const char *url_src =
      json_object_get_string(st_json_object_object_get(obj, name));
...
static int st_json_parse_tx_video(int idx, json_object *video_obj,
  ...
  /* parse enable rtcp */
  video->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(video_obj, "enable_rtcp"));
...
static int st_json_parse_rx_video(int idx, json_object *video_obj,
  ...
  const char *user_pg_format = json_object_get_string(
      st_json_object_object_get(video_obj, "user_pg_format"));
  ...
  video->measure_latency = json_object_get_boolean(
      st_json_object_object_get(video_obj, "measure_latency"));
...
static int parse_audio_type(json_object *audio_obj,
                            st_json_audio_info_t *audio) {
  const char *type =
      json_object_get_string(st_json_object_object_get(audio_obj, "type"));
  REQUIRED_ITEM(type);
  if (strcmp(type, "frame") == 0) {
...
static int parse_audio_format(json_object *audio_obj,
                              st_json_audio_info_t *audio) {
  const char *audio_format = json_object_get_string(
      st_json_object_object_get(audio_obj, "audio_format"));
...
static int parse_audio_channel(json_object *audio_obj,
                               st_json_audio_info_t *audio) {
  ...
  for (int i = 0; i < json_object_array_length(audio_channel_array); ++i) {
    json_object *channel_obj =
        json_object_array_get_idx(audio_channel_array, i);
...
static int parse_audio_sampling(json_object *audio_obj,
                                st_json_audio_info_t *audio) {
  const char *audio_sampling = json_object_get_string(
      st_json_object_object_get(audio_obj, "audio_sampling"));
...
static int parse_audio_ptime(json_object *audio_obj,
                             st_json_audio_info_t *audio) {
  const char *audio_ptime = json_object_get_string(
      st_json_object_object_get(audio_obj, "audio_ptime"));
  if (audio_ptime) {
...
static int st_json_parse_tx_audio(int idx, json_object *audio_obj,
  ...
  /* parse enable rtcp */
  audio->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(audio_obj, "enable_rtcp"));
...
static int st_json_parse_st30p(int idx, json_object *st30p_obj,
  ...
  /* parse enable rtcp */
  st30p->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(st30p_obj, "enable_rtcp"));
...
static int st_json_parse_tx_anc(int idx, json_object *anc_obj,
  ...
  /* parse anc type */
  const char *type =
      json_object_get_string(st_json_object_object_get(anc_obj, "type"));
  REQUIRED_ITEM(type);
  if (strcmp(type, "frame") == 0) {
  ...
  /* parse anc format */
  const char *anc_format = json_object_get_string(
      st_json_object_object_get(anc_obj, "ancillary_format"));
  ...
  /* parse anc fps */
  const char *anc_fps = json_object_get_string(
      st_json_object_object_get(anc_obj, "ancillary_fps"));
  ...
  json_object *anc_interlaced =
      st_json_object_object_get(anc_obj, "interlaced");
  if (anc_interlaced) {
  ...
  /* parse enable rtcp */
  anc->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(anc_obj, "enable_rtcp"));
...
static int parse_st22p_width(json_object *st22p_obj,
                             st_json_st22p_session_t *st22p) {
  int width =
      json_object_get_int(st_json_object_object_get(st22p_obj, "width"));
  if (width <= 0) {
...
static int parse_st22p_height(json_object *st22p_obj,
                              st_json_st22p_session_t *st22p) {
  int height =
      json_object_get_int(st_json_object_object_get(st22p_obj, "height"));
  if (height <= 0) {
...
static int parse_st22p_fps(json_object *st22p_obj,
                           st_json_st22p_session_t *st22p) {
  const char *fps =
      json_object_get_string(st_json_object_object_get(st22p_obj, "fps"));
  REQUIRED_ITEM(fps);
  if (strcmp(fps, "p59") == 0) {
...
static int parse_st22p_interlace(json_object *st22p_obj,
                                 st_json_st22p_session_t *st22p) {
...
static int parse_st22p_pack_type(json_object *st22p_obj,
                                 st_json_st22p_session_t *st22p) {
...
static int parse_st22p_codec(json_object *st22p_obj,
                             st_json_st22p_session_t *st22p) {
  const char *codec =
...
static int parse_st22p_device(json_object *st22p_obj,
                              st_json_st22p_session_t *st22p) {
  const char *device =
...
static int parse_st22p_quality(json_object *st22p_obj,
                               st_json_st22p_session_t *st22p) {
  const char *quality =
...
static int parse_st22p_format(json_object *st22p_obj,
                              st_json_st22p_session_t *st22p,
...
static int st_json_parse_tx_st22p(int idx, json_object *st22p_obj,
  ...
  st22p->info.codec_thread_count = json_object_get_int(
      st_json_object_object_get(st22p_obj, "codec_thread_count"));
  ...
  /* parse enable rtcp */
  st22p->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(st22p_obj, "enable_rtcp"));
...
static int st_json_parse_rx_st22p(int idx, json_object *st22p_obj,
  ...
  /* parse measure_latency option */
  st22p->measure_latency = json_object_get_boolean(
      st_json_object_object_get(st22p_obj, "measure_latency"));
...
static int parse_st20p_width(json_object *st20p_obj,
                             st_json_st20p_session_t *st20p) {
  int width =
      json_object_get_int(st_json_object_object_get(st20p_obj, "width"));
  if (width <= 0) {
    err("%s, invalid width %d\n", __func__, width);
    return -ST_JSON_NOT_VALID;
  }
...
static int parse_st20p_height(json_object *st20p_obj,
                              st_json_st20p_session_t *st20p) {
  int height =
      json_object_get_int(st_json_object_object_get(st20p_obj, "height"));
  if (height <= 0) {
    err("%s, invalid height %d\n", __func__, height);
    return -ST_JSON_NOT_VALID;
  }
...
static int parse_st20p_fps(json_object *st20p_obj,
                           st_json_st20p_session_t *st20p) {
  const char *fps =
      json_object_get_string(st_json_object_object_get(st20p_obj, "fps"));
  REQUIRED_ITEM(fps);
  if (strcmp(fps, "p59") == 0) {
...
static int parse_st20p_interlace(json_object *st20p_obj,
                                 st_json_st20p_session_t *st20p) {
...
static int parse_st20p_device(json_object *st20p_obj,
                              st_json_st20p_session_t *st20p) {
  const char *device =
...
static int parse_st20p_pacing(json_object *st20p_obj,
                              st_json_st20p_session_t *st20p) {
  const char *pacing =
...
static int parse_st20p_packing(json_object *st20p_obj,
                               st_json_st20p_session_t *st20p) {
  const char *packing =
...
static int parse_st20p_format(json_object *st20p_obj,
                              st_json_st20p_session_t *st20p,
                              const char *format_name) {
  const char *format =
...
static int parse_st20p_transport_format(json_object *st20p_obj,
                                        st_json_st20p_session_t *st20p) {
  const char *t_format = json_object_get_string(
      st_json_object_object_get(st20p_obj, "transport_format"));
...
static int st_json_parse_tx_st20p(int idx, json_object *st20p_obj,
  ...
  /* parse enable rtcp */
  st20p->enable_rtcp = json_object_get_boolean(
      st_json_object_object_get(st20p_obj, "enable_rtcp"));
...
static int st_json_parse_rx_st20p(int idx, json_object *st20p_obj,
  ...
  /* parse measure_latency option */
  st20p->measure_latency = json_object_get_boolean(
      st_json_object_object_get(st20p_obj, "measure_latency"));
...
static int parse_session_ip(const char *str_ip,
                            struct st_json_session_base *base,
...
static int parse_mcast_src_ip(const char *str_ip,
                              struct st_json_session_base *base,
                              enum mtl_session_port port) {
  int ret;
...
int st_app_parse_json(st_json_context_t *ctx, const char *filename) {
  ...
  if (obj != NULL)
    ctx->shared_tx_queues = json_object_get_boolean(obj);
  obj = st_json_object_object_get(root_object, "shared_rx_queues");
  if (obj != NULL)
    ctx->shared_rx_queues = json_object_get_boolean(obj);
  /* if disable the chain for tx */
  obj = st_json_object_object_get(root_object, "tx_no_chain");
  if (obj != NULL)
    ctx->tx_no_chain = json_object_get_boolean(obj);
  /* rss */
  ...
  json_object *interfaces_array =
      st_json_object_object_get(root_object, "interfaces");
  ...
  ctx->interfaces = (st_json_interface_t *)st_app_zmalloc(
      num_interfaces * sizeof(st_json_interface_t));
  if (!ctx->interfaces) {
  ...
  for (int i = 0; i < num_interfaces; ++i) {
    ret = st_json_parse_interfaces(
        json_object_array_get_idx(interfaces_array, i), &ctx->interfaces[i]);
    if (ret)
      goto error;
  }
  ...
  /* parse tx sessions  */
  json_object *tx_group_array =
      st_json_object_object_get(root_object, "tx_sessions");
  if (tx_group_array != NULL &&
      json_object_get_type(tx_group_array) == json_type_array) {
    ...
    for (int i = 0; i < json_object_array_length(tx_group_array); ++i) {
      ...
      if (dip_array != NULL &&
          json_object_get_type(dip_array) == json_type_array) {
      ...
      /* parse interface */
      int inf_p, inf_r = 0;
      json_object *interface_array =
          st_json_object_object_get(tx_group, "interface");
      if (interface_array != NULL &&
        ...
        inf_p =
            json_object_get_int(json_object_array_get_idx(interface_array, 0));
        ...
        if (len == 2) {
          inf_r = json_object_get_int(
              json_object_array_get_idx(interface_array, 1));
      ...
      if (video_array != NULL &&
          json_object_get_type(video_array) == json_type_array) {
        for (int j = 0; j < json_object_array_length(video_array); ++j) {
          json_object *video_session =
              json_object_array_get_idx(video_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(video_session, "replicas"));
          if (replicas < 0) {
            err("%s, invalid replicas number: %d\n", __func__, replicas);
            ret = -ST_JSON_NOT_VALID;
            goto error;
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             ...
                             MTL_SESSION_PORT_P);
            ctx->tx_video_sessions[num_video].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].tx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_video_sessions[num_video].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_video_sessions[num_video].base.inf[1] =
                  &ctx->interfaces[inf_r];
            ...
            if (ret)
              goto error;
            if (ctx->tx_video_sessions[num_video].display)
      ...
      if (audio_array != NULL &&
          json_object_get_type(audio_array) == json_type_array) {
        for (int j = 0; j < json_object_array_length(audio_array); ++j) {
          json_object *audio_session =
              json_object_array_get_idx(audio_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(audio_session, "replicas"));
          if (replicas < 0) {
            err("%s, invalid replicas number: %d\n", __func__, replicas);
            ret = -ST_JSON_NOT_VALID;
            goto error;
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             ...
                             MTL_SESSION_PORT_P);
            ctx->tx_audio_sessions[num_audio].base.inf[0] =
                &ctx->interfaces[inf_p];
            ...
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_audio_sessions[num_audio].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_audio_sessions[num_audio].base.inf[1] =
                  &ctx->interfaces[inf_r];
      ...
      if (anc_array != NULL &&
        ...
        for (int j = 0; j < json_object_array_length(anc_array); ++j) {
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             &ctx->tx_anc_sessions[num_anc].base,
                             MTL_SESSION_PORT_P);
            ...
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_anc_sessions[num_anc].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_anc_sessions[num_anc].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].tx_anc_sessions_cnt++;
            }
            ctx->tx_anc_sessions[num_anc].base.num_inf = num_inf;
            ret = st_json_parse_tx_anc(k, anc_session,
                                       &ctx->tx_anc_sessions[num_anc]);
            if (ret)
              goto error;
            num_anc++;
          }
      ...
      if (st22p_array != NULL &&
          json_object_get_type(st22p_array) == json_type_array) {
        for (int j = 0; j < json_object_array_length(st22p_array); ++j) {
          json_object *st22p_session =
              json_object_array_get_idx(st22p_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(st22p_session, "replicas"));
          if (replicas < 0) {
            err("%s, invalid replicas number: %d\n", __func__, replicas);
            ret = -ST_JSON_NOT_VALID;
            goto error;
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             ...
                             MTL_SESSION_PORT_P);
            ctx->tx_st22p_sessions[num_st22p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].tx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_st22p_sessions[num_st22p].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_st22p_sessions[num_st22p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].tx_video_sessions_cnt++;
            }
            ...
            if (ret)
              goto error;
            if (ctx->tx_st22p_sessions[num_st22p].display)
              ctx->has_display = true;
            num_st22p++;
          }
        }
      ...
      if (st20p_array != NULL &&
          json_object_get_type(st20p_array) == json_type_array) {
        for (int j = 0; j < json_object_array_length(st20p_array); ++j) {
          json_object *st20p_session =
              json_object_array_get_idx(st20p_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(st20p_session, "replicas"));
          if (replicas < 0) {
            err("%s, invalid replicas number: %d\n", __func__, replicas);
            ret = -ST_JSON_NOT_VALID;
            goto error;
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             ...
                             MTL_SESSION_PORT_P);
            ctx->tx_st20p_sessions[num_st20p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].tx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_st20p_sessions[num_st20p].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_st20p_sessions[num_st20p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].tx_video_sessions_cnt++;
            }
            ...
            if (ret)
              goto error;
            if (ctx->tx_st20p_sessions[num_st20p].display)
              ctx->has_display = true;
            num_st20p++;
          }
        }
      ...
      if (st30p_array != NULL &&
          json_object_get_type(st30p_array) == json_type_array) {
        for (int j = 0; j < json_object_array_length(st30p_array); ++j) {
          json_object *st30p_session =
              json_object_array_get_idx(st30p_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(st30p_session, "replicas"));
          if (replicas < 0) {
          ...
          for (int k = 0; k < replicas; ++k) {
            parse_session_ip(json_object_get_string(dip_p),
                             ...
                             MTL_SESSION_PORT_P);
            ctx->tx_st30p_sessions[num_st30p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].tx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(dip_r),
                               &ctx->tx_st30p_sessions[num_st30p].base,
                               MTL_SESSION_PORT_R);
              ctx->tx_st30p_sessions[num_st30p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].tx_video_sessions_cnt++;
            }
            ctx->tx_st30p_sessions[num_st30p].base.num_inf = num_inf;
            ret = st_json_parse_st30p(
                k, st30p_session, &ctx->tx_st30p_sessions[num_st30p], false);
            if (ret)
              goto error;
            num_st30p++;
          }
  ...
  /* parse rx sessions */
  json_object *rx_group_array =
      st_json_object_object_get(root_object, "rx_sessions");
  if (rx_group_array != NULL &&
      json_object_get_type(rx_group_array) == json_type_array) {
    /* parse session numbers for array allocation */
    ...
    for (int i = 0; i < json_object_array_length(rx_group_array); ++i) {
      ...
      if (ip_array != NULL &&
          json_object_get_type(ip_array) == json_type_array) {
      ...
      int inf_p, inf_r = 0;
      json_object *interface_array =
          st_json_object_object_get(rx_group, "interface");
      if (interface_array != NULL &&
          json_object_get_type(interface_array) == json_type_array) {
        int len = json_object_array_length(interface_array);
        if (len != num_inf) {
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_video_sessions[num_video].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_video_sessions[num_video].base.inf[0] =
                &ctx->interfaces[inf_p];
            ...
            if (num_inf == 2) {
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_video_sessions[num_video].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_video_sessions[num_video].base.inf[1] =
                  &ctx->interfaces[inf_r];
            ...
            if (ret)
              goto error;
            if (ctx->rx_video_sessions[num_video].display)
              ctx->has_display = true;
            num_video++;
          }
        }
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_audio_sessions[num_audio].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_audio_sessions[num_audio].base.inf[0] =
                &ctx->interfaces[inf_p];
            ...
            if (num_inf == 2) {
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_audio_sessions[num_audio].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_audio_sessions[num_audio].base.inf[1] =
                  &ctx->interfaces[inf_r];
            ...
            if (num_inf == 2) {
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_anc_sessions[num_anc].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_anc_sessions[num_anc].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].rx_anc_sessions_cnt++;
            }
            ctx->rx_anc_sessions[num_anc].base.num_inf = num_inf;
            ret = st_json_parse_rx_anc(k, anc_session,
                                       &ctx->rx_anc_sessions[num_anc]);
            if (ret)
              goto error;
            num_anc++;
          }
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_st22p_sessions[num_st22p].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_st22p_sessions[num_st22p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].rx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(ip_r),
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_st22p_sessions[num_st22p].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_st22p_sessions[num_st22p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].rx_video_sessions_cnt++;
            }
            ...
            if (ret)
              goto error;
            if (ctx->rx_st22p_sessions[num_st22p].display)
              ctx->has_display = true;
            num_st22p++;
          }
        }
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_st20p_sessions[num_st20p].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_st20p_sessions[num_st20p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].rx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(ip_r),
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_st20p_sessions[num_st20p].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_st20p_sessions[num_st20p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].rx_video_sessions_cnt++;
            }
            ...
            if (ret)
              goto error;
            if (ctx->rx_st20p_sessions[num_st20p].display)
              ctx->has_display = true;
            num_st20p++;
          }
        }
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_st30p_sessions[num_st30p].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_st30p_sessions[num_st30p].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].rx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(ip_r),
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_st30p_sessions[num_st30p].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_st30p_sessions[num_st30p].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].rx_video_sessions_cnt++;
            }
      ...
      if (st20r_array != NULL &&
          json_object_get_type(st20r_array) == json_type_array) {
        if (num_inf != 2) {
        ...
        for (int j = 0; j < json_object_array_length(st20r_array); ++j) {
          json_object *st20r_session =
              json_object_array_get_idx(st20r_array, j);
          int replicas = json_object_get_int(
              st_json_object_object_get(st20r_session, "replicas"));
          if (replicas < 0) {
          ...
          for (int k = 0; k < replicas; ++k) {
            ...
            if (mcast_src_ip_p)
              parse_mcast_src_ip(json_object_get_string(mcast_src_ip_p),
                                 &ctx->rx_st20r_sessions[num_st20r].base,
                                 MTL_SESSION_PORT_P);
            ctx->rx_st20r_sessions[num_st20r].base.inf[0] =
                &ctx->interfaces[inf_p];
            ctx->interfaces[inf_p].rx_video_sessions_cnt++;
            if (num_inf == 2) {
              parse_session_ip(json_object_get_string(ip_r),
              ...
              if (mcast_src_ip_r)
                parse_mcast_src_ip(json_object_get_string(mcast_src_ip_r),
                                   &ctx->rx_st20r_sessions[num_st20r].base,
                                   MTL_SESSION_PORT_R);
              ctx->rx_st20r_sessions[num_st20r].base.inf[1] =
                  &ctx->interfaces[inf_r];
              ctx->interfaces[inf_r].rx_video_sessions_cnt++;
            }
            ...
            if (ret)
              goto error;
            if (ctx->rx_st20r_sessions[num_st20r].display)
              ctx->has_display = true;
            num_st20r++;
          }
        }
...
uint8_t *st_json_ip(struct st_app_context *ctx, st_json_session_base_t *base,
  ...
  if (base->type[port] == ST_JSON_IP_LOCAL_IF) {
    mtl_port_ip_info(ctx->st, base->local[port], base->local_ip[port], NULL,
                     NULL);
