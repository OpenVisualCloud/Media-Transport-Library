...
static int perf_cvt_422_10_pg2_to_planar_le(int w, int h, int frames) {
  ...
  for (int i = 0; i < frames; i++) {
    st20_rfc4175_422be10_to_yuv422p10le_simd(pg, p10_u16, p10_u16_b, p10_u16_r, w, h,
                                             ST_SIMD_LEVEL_NONE);
  }
  end = clock();
...
int main(int argc, char** argv) {
  perf_cvt_422_10_pg2_to_planar_le(640, 480, 60);
  perf_cvt_422_10_pg2_to_planar_le(1280, 720, 60);
  perf_cvt_422_10_pg2_to_planar_le(1920, 1080, 60);
  perf_cvt_422_10_pg2_to_planar_le(1920 * 2, 1080 * 2, 60);
  perf_cvt_422_10_pg2_to_planar_le(1920 * 4, 1080 * 4, 60);
  return 0;
}
