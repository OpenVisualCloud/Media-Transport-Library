...
static int perf_cvt_422_10_pg2_be_to_y210(st_handle st, int w, int h, int frames,
                                          int fb_cnt) {
  ...
  for (int i = 0; i < frames; i++) {
    ...
    st20_rfc4175_422be10_to_y210_simd(pg_be_in, pg_y210_out, w, h, ST_SIMD_LEVEL_NONE);
  }
  end = clock();
