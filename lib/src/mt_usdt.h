...
#define MT_DTRACE_PROBE6(provider, probe, parm1, parm2, parm3, parm4, parm5,   \
                         parm6)                                                \
  DTRACE_PROBE6(provider, probe, parm1, parm2, parm3, parm4, parm5, parm6)
#define MT_DTRACE_PROB76(provider, probe, parm1, parm2, parm3, parm4, parm5,   \
                         parm6, parm7)                                         \
...
#define MT_USDT_SYS_LOG_MSG(level, msg)                                        \
  MT_DTRACE_PROBE2(sys, log_msg, level, msg)
...
#define MT_USDT_TASKLET_TIME_MEASURE_ENABLED()                                 \
  SYS_TASKLET_TIME_MEASURE_ENABLED()

#define MT_SYS_SESSIONS_TIME_MEASURE()                                         \
  MT_DTRACE_PROBE(sys, sessions_time_measure)
#define MT_USDT_SESSIONS_TIME_MEASURE_ENABLED()                                \
  SYS_SESSIONS_TIME_MEASURE_ENABLED()
...
#define MT_USDT_ST20P_RX_FRAME_AVAILABLE(idx, f_idx, va, tmstamp, data_size)   \
  MT_DTRACE_PROBE5(st20p, rx_frame_available, idx, f_idx, va, tmstamp,         \
                   data_size)
...
#define MT_USDT_ST30P_RX_FRAME_AVAILABLE(idx, f_idx, va, tmstamp, data_size)   \
  MT_DTRACE_PROBE5(st30p, rx_frame_available, idx, f_idx, va, tmstamp,         \
                   data_size)
...
#define MT_USDT_ST20_RX_FRAME_AVAILABLE(m_idx, s_idx, f_idx, va, tmstamp,      \
                                        data_size)                             \
  MT_DTRACE_PROBE6(st20, rx_frame_available, m_idx, s_idx, f_idx, va, tmstamp, \
                   data_size)
...
#define MT_USDT_ST20_RX_FRAME_INCOMPLETE(m_idx, s_idx, f_idx, tmstamp,         \
                                         data_size, expect_size)               \
  MT_DTRACE_PROBE6(st20, rx_frame_incomplete, m_idx, s_idx, f_idx, tmstamp,    \
                   data_size, expect_size)
...
#define MT_USDT_ST30_RX_FRAME_AVAILABLE(m_idx, s_idx, f_idx, va, tmstamp,      \
                                        data_size)                             \
  MT_DTRACE_PROBE6(st30, rx_frame_available, m_idx, s_idx, f_idx, va, tmstamp, \
                   data_size)
...
#define MT_USDT_ST40_TX_FRAME_NEXT(m_idx, s_idx, f_idx, va, meta_num,          \
                                   total_udw)                                  \
  MT_DTRACE_PROBE6(st40, tx_frame_next, m_idx, s_idx, f_idx, va, meta_num,     \
                   total_udw)
...
#define MT_USDT_ST40_RX_MBUF_AVAILABLE(m_idx, s_idx, mbuf, tmstamp, data_size) \
  MT_DTRACE_PROBE5(st40, rx_mbuf_available, m_idx, s_idx, mbuf, tmstamp,       \
                   data_size)
...
#define MT_USDT_ST22_RX_FRAME_AVAILABLE(m_idx, s_idx, f_idx, va, tmstamp,      \
                                        data_size)                             \
  MT_DTRACE_PROBE6(st22, rx_frame_available, m_idx, s_idx, f_idx, va, tmstamp, \
                   data_size)
...
#define MT_USDT_ST22P_RX_FRAME_AVAILABLE(idx, f_idx, va, tmstamp, data_size)   \
  MT_DTRACE_PROBE5(st22p, rx_frame_available, idx, f_idx, va, tmstamp,         \
                   data_size)
...
#define MT_USDT_ST22P_TX_ENCODE_PUT(idx, f_idx, src, dst, result, data_size)   \
  MT_DTRACE_PROBE6(st22p, tx_encode_put, idx, f_idx, src, dst, result,         \
                   data_size)
