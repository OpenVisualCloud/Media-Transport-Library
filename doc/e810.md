...
### 1.1 Download driver version with 1.12.7
...
### 1.2 Unzip 1.12.7 driver and enter into the source code directory
...
### 1.3 Patch 1.12.7 driver with rate limit patches

Apply the all patches under [ice_driver](../patches/ice_drv/1.12.7/)
