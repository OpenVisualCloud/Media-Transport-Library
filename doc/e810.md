...
#### 1.3.1 ice 1.11.14 patch for RHEL 9

Apply the patch to fix build with RHEL 9 `Linux version 5.14.0-284.18.1.el9_2.x86_64` version

```bash
# WA for RHEL 9 build
git am $imtl_source_code/patches/ice_drv/1.11.14/RHEL9/0001-RHEL9-fix-build-with-5.14.0-284.patch
```
